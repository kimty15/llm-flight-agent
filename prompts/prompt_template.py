...
Your task is to classify whether a query is about food/restaurants or general tourism information.
...
Classify the following query as either "food_search_agent" or "retrieval_agent":
